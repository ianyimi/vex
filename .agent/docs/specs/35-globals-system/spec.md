...
- [x] `packages/core/src/types/generateVexTypes.ts` — emit globals into `GeneratedVexTypes`
- [x] `packages/core/src/types/generateVexTypes.test.ts` — add globals tests
...
- [x] `packages/core/src/schema/generateVexSchema.ts`
- [x] `packages/core/src/schema/generateVexSchema.test.ts`
...
- [x] `packages/core/src/api/globals/get.server.ts` (NEW)
- [x] `packages/core/src/api/globals/get.server.test.ts` (NEW)
- [x] `packages/core/src/api/globals/find.server.ts` (NEW)
- [x] `packages/core/src/api/globals/find.server.test.ts` (NEW)
- [x] `packages/core/src/api/globals/update.server.ts` (NEW)
- [x] `packages/core/src/api/globals/update.server.test.ts` (NEW)
...
- [x] `packages/core/src/api/globals/get.client.ts` (NEW)
- [x] `packages/core/src/api/globals/find.client.ts` (NEW)
- [x] `packages/core/src/api/globals/update.client.ts` (NEW)
- [x] `packages/core/src/api/convex.ts` — add `VexGlobalsGetArgs`, `VexGlobalsFindArgs`, `VexGlobalsUpdateArgs` + `vexConvexApi.globals.*`
- [x] `packages/core/src/api/client.ts` — export globals client fns
- [x] `packages/core/src/api/server.ts` — export globals server fns (factory in Step 6)
...
- [x] `packages/core/src/api/server.ts` — add `globalsApi` factory
...
- [x] `packages/react/src/components/views/GlobalsListView.tsx` (NEW)
- [x] `packages/react/src/components/views/GlobalEditView.tsx` (NEW)
- [x] `packages/react/src/components/views/index.tsx` — add exports
...
- [x] `packages/react/src/components/layout/AppSidebar.tsx`
...
- `.agent/docs/specs/36-versioning-drafts/research.md` — versioning deferred; `GlobalConfig.versions` kept for forward compat
- `.agent/docs/design/claude-design/admin/screens.jsx` — `GlobalEditView` layout reference
