# Project State
> GENERATED by `harness state` — do not edit. SHA: 9c9cca5126d0a4778ed1515553e48241ddd7e3bf
...
- 2026-09-12-config-client-server-split — draft — 27 open / 27 total tasks
