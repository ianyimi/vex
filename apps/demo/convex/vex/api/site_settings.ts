...
import { getDocument, listDocuments, createDocument, updateDocument, deleteDocument } from "../model/api/site_settings"

const SLUG = "site_settings" as const
...
export const update = mutation({
  args: { id: v.id("site_settings"), fields: v.any() },
  handler: async (ctx, args) => {
    const { user, roles } = await requireAuth(ctx)
    hasPermission({
      access: vexConfig.access,
