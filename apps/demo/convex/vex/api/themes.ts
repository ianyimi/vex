...
import { getDocument, listDocuments, createDocument, updateDocument, deleteDocument } from "../model/api/themes"

const SLUG = "themes" as const
...
export const update = mutation({
  args: { id: v.id("themes"), fields: v.any() },
  handler: async (ctx, args) => {
    const { user, roles } = await requireAuth(ctx)
    hasPermission({
      access: vexConfig.access,
