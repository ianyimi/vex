...
import { getDocument, listDocuments, createDocument, updateDocument, deleteDocument } from "../model/api/headers"

const SLUG = "headers" as const
...
export const update = mutation({
  args: { id: v.id("headers"), fields: v.any() },
  handler: async (ctx, args) => {
    const { user, roles } = await requireAuth(ctx)
    hasPermission({
      access: vexConfig.access,
