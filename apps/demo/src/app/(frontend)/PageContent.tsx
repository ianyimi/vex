    ...
    if (normalizedSlug === "home") {
      return (
        <div className="flex min-h-screen flex-col items-center justify-center gap-4 p-8">
          <h1 className="text-4xl font-bold tracking-tight">Vex CMS Demo</h1>
          <p className="text-lg text-muted-foreground">
            The demo content is loading or has been reset. Visit the{" "}
            <a href="/admin" className="text-primary underline">admin panel</a> to create content.
          </p>
        </div>
      )
    }
