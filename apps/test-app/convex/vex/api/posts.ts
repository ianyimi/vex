...
import { createDocument, deleteDocument, getDocument, listDocuments, updateDocument } from "../model/api/posts"

const SLUG = "posts" as const
...
export const update = mutation({
  args: { id: v.id("posts"), fields: v.any() },
  handler: async (ctx, args) => {
    const { roles, user } = await requireAuth(ctx)
    hasPermission({
      access: vexConfig.access,
