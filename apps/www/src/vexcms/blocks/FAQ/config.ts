      ...
      defaultValue: [
        {
          ...
          answer:
            "Vex CMS is a headless content management system built on Convex. It provides real-time data, type-safe schemas, database-driven theming, role-based access control, and a full admin panel — all configured in TypeScript. Live preview ships today; versioning and drafts are in progress — see the roadmap.",
        },
        {
