...
import { getDocument, listDocuments, createDocument, updateDocument, deleteDocument } from "../model/api/footers"

const SLUG = "footers" as const
...
export const update = mutation({
  args: { id: v.id("footers"), fields: v.any() },
  handler: async (ctx, args) => {
    const { user, roles } = await requireAuth(ctx)
    hasPermission({
      access: vexConfig.access,
