 ...
 * one instance everywhere is what lets a page and its `generateMetadata`
 * collapse their identical `pages.getBySlug` read into a single Convex call
 * within one request, instead of two.
 */
