...
- Building a public site (blog, marketing pages) meant to prerender and serve from the CDN?
  See [Caching, sitemaps & revalidation](/guides/caching-and-seo/) — the scaffolded
  marketing-site starter already wires all of it; that guide explains how, and what to add
  yourself on a `--bare` project or an existing app.
