  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          // `h-svh overflow-hidden`, not `min-h-svh`: the admin shell pins itself
          // to the viewport and the content area (`SidebarInset`'s `main`) owns the
          // only scrollbar. A growing wrapper puts the scrollbar on the window, which
          // then appears and disappears as views change height.
