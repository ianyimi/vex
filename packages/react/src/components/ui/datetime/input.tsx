...
/**
 * Segmented date/time text input that parses a `date-fns` format string into
 * individually editable date segments (year, month, day, hour, minute, etc.).
 * Shows a validation icon and calls `onChange` whenever a fully valid date is entered.
 */
